...
def scientific_names_from_prototype_site():
    url='http://spatialecology.jcu.edu.au/AustralianBirds/php/listspecies.php'
...
def data_sources_for_records_for_species(scientific_name):
    ...
    if lsid is None: return
    request = ala.create_request(
        ala.BIOCACHE + 'ws/occurrences/search',
        {
